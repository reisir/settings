...
IfTrueAction=[!SetVariable "s_Scroll$($Side)" "[&ScrollDown$($Side)]"][!DisableMeasure "ScrollDown$($Side)"][!Update][#s_SaveScroll]
...
IfTrueAction=[!SetVariable "s_Scroll$($Side)" "[&ScrollUp$($Side)]"][!DisableMeasure "ScrollUp$($Side)"][!Update][#s_SaveScroll]
